namespace Biblioteca.Usuario
{
    partial class frmPrestamos
    {
        ...
        private void InitializeComponent()
        {
            ...
            bSolicitador = new Button();
            bPrestador = new Button();
            chbDevuelto = new CheckBox();
            dtpTermino = new DateTimePicker();
            tbLibro = new TextBox();
            label3 = new Label();
            label2 = new Label();
            tbSolicitador = new TextBox();
            amongus = new Label();
            tbPrestador = new TextBox();
            lNombre = new Label();
            tbId = new TextBox();
            lId = new Label();
            ...
            // pEncabezado
            // 
            pEncabezado.Controls.Add(bLibro);
            pEncabezado.Controls.Add(bSolicitador);
            pEncabezado.Controls.Add(bPrestador);
            pEncabezado.Controls.Add(chbDevuelto);
            pEncabezado.Controls.Add(dtpTermino);
            pEncabezado.Controls.Add(tbLibro);
            pEncabezado.Controls.Add(label3);
            pEncabezado.Controls.Add(label2);
            pEncabezado.Controls.Add(tbSolicitador);
            pEncabezado.Controls.Add(amongus);
            pEncabezado.Controls.Add(tbPrestador);
            ...
            // 
            bLibro.ImageIndex = 0;
            bLibro.ImageList = imageList1;
            bLibro.Location = new Point(664, 125);
            bLibro.Name = "bLibro";
            bLibro.Size = new Size(41, 34);
            bLibro.TabIndex = 17;
            ...
            // bSolicitador
            // 
            bSolicitador.ImageIndex = 0;
            bSolicitador.ImageList = imageList1;
            bSolicitador.Location = new Point(664, 82);
            bSolicitador.Name = "bSolicitador";
            bSolicitador.Size = new Size(41, 34);
            bSolicitador.TabIndex = 16;
            bSolicitador.UseVisualStyleBackColor = true;
            bSolicitador.Click += bSolicitador_Click;
            // 
            // bPrestador
            // 
            bPrestador.ImageIndex = 0;
            bPrestador.ImageList = imageList1;
            bPrestador.Location = new Point(664, 42);
            bPrestador.Name = "bPrestador";
            bPrestador.Size = new Size(41, 34);
            bPrestador.TabIndex = 15;
            bPrestador.UseVisualStyleBackColor = true;
            bPrestador.Click += bPrestador_Click;
            // 
            // chbDevuelto
            // 
            chbDevuelto.AutoSize = true;
            chbDevuelto.Font = new Font("Segoe UI", 12F);
            chbDevuelto.Location = new Point(160, 208);
            chbDevuelto.Name = "chbDevuelto";
            chbDevuelto.Size = new Size(113, 32);
            chbDevuelto.TabIndex = 14;
            chbDevuelto.Text = "Devuelto";
            chbDevuelto.UseVisualStyleBackColor = true;
            // 
            // dtpTermino
            // 
            dtpTermino.CalendarFont = new Font("Segoe UI", 12F);
            dtpTermino.Format = DateTimePickerFormat.Short;
            dtpTermino.Location = new Point(227, 162);
            dtpTermino.Name = "dtpTermino";
            dtpTermino.Size = new Size(123, 27);
            dtpTermino.TabIndex = 13;
            dtpTermino.Value = new DateTime(2026, 4, 23, 0, 0, 0, 0);
            // 
            // tbLibro
            // 
            tbLibro.Enabled = false;
            tbLibro.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            tbLibro.Location = new Point(160, 122);
            tbLibro.Name = "tbLibro";
            tbLibro.Size = new Size(498, 34);
            tbLibro.TabIndex = 12;
            // 
            // label3
            // 
            ...
            // tbSolicitador
            // 
            tbSolicitador.Enabled = false;
            tbSolicitador.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            tbSolicitador.Location = new Point(160, 82);
            tbSolicitador.Name = "tbSolicitador";
            tbSolicitador.Size = new Size(498, 34);
            tbSolicitador.TabIndex = 5;
            // 
            // amongus
            // 
            amongus.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            amongus.Location = new Point(25, 82);
            amongus.Name = "amongus";
            amongus.Size = new Size(129, 28);
            amongus.TabIndex = 4;
            amongus.Text = "Solicitador:";
            amongus.TextAlign = ContentAlignment.MiddleRight;
            // 
            // tbPrestador
            // 
            tbPrestador.Enabled = false;
            tbPrestador.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            tbPrestador.Location = new Point(160, 42);
            tbPrestador.Name = "tbPrestador";
            tbPrestador.Size = new Size(498, 34);
            tbPrestador.TabIndex = 3;
            // 
            // lNombre
            // 
        ...
        private TextBox tbSolicitador;
        private Label amongus;
        private TextBox tbPrestador;
        ...
        private CheckBox chbDevuelto;
        private DateTimePicker dtpTermino;
        private TextBox tbLibro;
        private Button bLibro;
        private ImageList imageList1;
        private Button bSolicitador;
        private Button bPrestador;
    }
}